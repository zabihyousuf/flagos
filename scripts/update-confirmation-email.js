...
const subject = 'Confirm your FlagLab account'
const html = `<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Confirm your FlagLab account</title>
</head>
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; line-height: 1.6; color: #333; max-width: 560px; margin: 0 auto; padding: 24px;">
  <h1 style="font-size: 24px; margin-bottom: 16px;">Welcome to FlagLab</h1>
  <p>Thanks for signing up. FlagLab is your platform for designing flag football plays, building playbooks, managing your roster, and simulating plays.</p>
  ...
  <p style="font-size: 13px; color: #94a3b8;">If you didn’t create a FlagLab account, you can safely ignore this email.</p>
</body>
</html>`
