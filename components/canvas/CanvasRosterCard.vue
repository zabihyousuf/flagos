    ...
    <div class="p-2 overflow-y-auto custom-scrollbar flex flex-col gap-3 min-h-0 flex-1">
      ...
      <div v-if="players.length > 0" class="space-y-1">
        ...
        <div class="space-y-1">
          ...
          >
            <div
              class="w-5 h-5 rounded-full flex items-center justify-center text-white text-[9px] font-bold shrink-0 shadow-sm"
      ...
      <div class="space-y-1 flex-1">
        <p class="text-[9px] font-bold text-muted-foreground uppercase tracking-wider px-1">Bench</p>
        <div class="space-y-1">
          <div
          ...
          >
            <span class="text-[9px] text-muted-foreground font-mono w-5 text-center">{{ player.number }}</span>
